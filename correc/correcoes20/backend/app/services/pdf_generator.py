...
MARGIN_INTERIOR = 2.5 * cm
MARGIN_EXTERIOR = 1.5 * cm
COL_GAP         = 0.4 * cm
...
def _make_styles():
    s = {}
    s["body"] = ParagraphStyle("body", fontName=_BASE_FONT, fontSize=_BASE_SIZE, leading=_BASE_LEADING, alignment=TA_JUSTIFY, spaceAfter=2)
    s["stem"] = ParagraphStyle("stem", fontName=_BASE_FONT, fontSize=_BASE_SIZE, leading=_BASE_LEADING, alignment=TA_JUSTIFY, spaceBefore=2, spaceAfter=2)
    s["option"] = ParagraphStyle("option", fontName=_BASE_FONT, fontSize=_BASE_SIZE, leading=_BASE_LEADING, alignment=TA_JUSTIFY, leftIndent=10, spaceAfter=1)
    s["question_number"] = ParagraphStyle("question_number", fontName=_BASE_FONT_BOLD, fontSize=_BASE_SIZE, leading=_BASE_LEADING, spaceBefore=5, spaceAfter=1)
    ...
    s["instruction"] = ParagraphStyle("instruction", fontName="Times-Italic", fontSize=_BASE_SIZE, leading=_BASE_LEADING, alignment=TA_JUSTIFY, spaceAfter=3)
    return s
...
def _build_booklet(exam, questions, output_path, student_name="", student_id=0,
    ...
    # Questões — sem páginas de rascunho intermediárias
    ...
    # Uma única página de rascunho ao final do caderno
